    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj_type', models.CharField(choices=[('prim', 'Primary objective from mission'), ('sec', 'Secondary objective mission')], default='sec', max_length=10, verbose_name='Тип класса обжективов')),
            ],
            options={
